...
export const dummyEducatorData = {
  ...
  name: "Presync Academy",
  email: "instructor@presync.academy",
  imageUrl:
...
export const dummyTestimonial = [
  {
    ...
    rating: 5,
    feedback:
      "Presync Academy has completely transformed my learning experience. The courses are well-structured and the instructors are incredibly knowledgeable. Highly recommend!",
  },
  {
    name: "Michael Chen",
    ...
    rating: 4,
    feedback:
      "The hands-on approach at Presync Academy helped me transition into data science seamlessly. The practical projects really made the difference in my career.",
  },
  {
    ...
    rating: 4.5,
    feedback:
      "Outstanding platform! Presync Academy's comprehensive curriculum and expert guidance helped me land my dream job. The investment was absolutely worth it.",
  },
];
